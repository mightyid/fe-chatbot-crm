...
const features = computed(() => [
  {
    image: smartapply1,
    title: t('home.Theo dõi hồ sơ online thời gian thực'),
  ...
  },
  {
    ...
    description: t('home.Liên kết chặt chẽ giữa học sinh, trường học và tư vấn viên'),
  },
  {
    image: smartapply3,
    title: t('home.Dữ liệu lưu trữ an toàn trên Cloud S3'),

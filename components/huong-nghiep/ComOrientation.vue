...
<template>
  <div class="container mx-a fc max-w-1200px">
    <div class="text-center text-2xl lg:text-5xl leading-36px lg:leading-68px font-bold max-w-1200px mx-a">
      Chatbot hướng nghiệp AI - Tối ưu hóa định hướng nghề nghiệp
    </div>
    <div class="mt-8 w-full grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div class="row-span-1 lg:row-span-2 bg-#E7F7FE p-4 rounded h-full fc ai-c">

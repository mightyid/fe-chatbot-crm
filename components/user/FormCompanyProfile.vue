    ...
    <div class="grid grid-cols-2 gap-6">
      <div class="grid-row-span-2">
        <BaseButtonUpload acceptFile="image/*" @onUpload="onUpload" :acl="true">
          <BaseAvatar :url="form.logo" type="square" :size="125" aspect="126/160" v-if="form.logo" />
      ...
      <BaseInputText
        ...
        :disabled="true"
      />
      <BaseInputText class="flex-1" name="phone" label="Phone" :rules="{ required: false }" v-model="form.phone" />
      <BaseInputTextArea
        class="flex-1"
        name="description"
        label="Description"
